...
const NIGERIA_STATES_LGAS = {
  ...
  Borno: [
    ...
    "Magumeri", "Maiduguri", "Marte", "Mobbar", "Monguno",
    "Ngala", "Nganzai", "Shani"
  ],
  "Cross River": [
  ...
  Kebbi: [
    ...
    "Maiyama", "Ngaski", "Sakaba", "Shanga", "Suru", "Danko/Wasagu",
    "Yauri", "Zuru"
  ],
  Kogi: [
...
const ALL_NIGERIAN_STATES = Object.keys(NIGERIA_STATES_LGAS);

// Tabbatar da samun dama a Browser (Global Window Scope)
if (typeof window !== "undefined") {
  window.NIGERIA_STATES_LGAS = NIGERIA_STATES_LGAS;
  window.ALL_NIGERIAN_STATES = ALL_NIGERIAN_STATES;
}

// Tallafi ga ES Modules
if (typeof module !== "undefined" && module.exports) {
  module.exports = { NIGERIA_STATES_LGAS, ALL_NIGERIAN_STATES };
}